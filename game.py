...
def execute_take(item_id):
    ...
    for check_items in items:
        if check_items["id"] == item_id:
            if (mass + check_items["mass"]) > max_mass:
                print("You Do Not Have Enough Space To Carry This")
                presence_check = True
                break
            else:
                mass = mass + check_items["mass"]
...
def victory():
    print("\n\nCongratulations!!! You Have Won The Game!\n\nYou Dropped The Biscuits At The Coffee\n\n")
    quit()
...
def main():
    ...
    while True:
        ...
        if items["biscuits"] in current_room["items"]:
            if current_room["name"] == "your personal tutor's office":
                victory()
        print_room(current_room)
        print_inventory_items(inventory)
        print("Your Total Weight Of Carrying Is: " + str(mass) + "/3000")
...
if __name__ == "__main__":
    print("\n\n\nYour Objective Is To Find The Biscuits\nAnd To Place Them Next To The Coffee\n\n\n")
    main()
